...
//  this._request({'path': '/address', 'body': {'network': 'dash', 'currency': 'DASH'}, 'method': 'post'}, function(err, res) {
//    console.log(res)
//  })
//  jsonquest.emitter.on('networkUp', function () { this.emit('networkUp') })
//  jsonquest.emitter.on('networkDown', function () { this.emit('networkDown') })
}
...
Trader.prototype.rates = function rates (cryptoCode) {
  if (this._rates && this._rates[cryptoCode]) return this._rates[cryptoCode]
